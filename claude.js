exports.handler = async function(event) {
  ...
  // If path is /list, return available models
  if (event.path && event.path.includes('list')) {
    var API_KEY = 'AIzaSyBK1aR4h7vUa82rHFwaHaqORD17dvytLB8';
    var listUrl = 'https://generativelanguage.googleapis.com/v1beta/models?key=' + API_KEY;
